...
Do not pass shell expressions or secrets as parameters. Argument handling varies by script; Teams removal/reinstall ignores unsupported keys. No parameter should be treated as shell code.
