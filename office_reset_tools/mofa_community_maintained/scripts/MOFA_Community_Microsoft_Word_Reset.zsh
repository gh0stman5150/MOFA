...
# Description: Resets the Microsoft Word
#
# Version History:
...
echo "Office-Reset: Running as: $LoggedInUser; Home Folder: $HOME; Temp Folder: $TMPDIR; Mode: $MODE"
...
if [ -d "/Applications/Microsoft Word.app" ]; then
	...
	if [[ "${CUSTOM_VERSION}" ]] && [[ "${APP_VERSION}" != "${CUSTOM_VERSION}" ]]; then
		if shouldReinstall; then
			...
			removePathList "/Applications/Microsoft Word.app"
			RepairApp
		else
